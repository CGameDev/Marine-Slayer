    ...
    public static class CanonicalWeaponCatalog
    {
        public static WeaponDefinition[] CreateAll()
        {
            return new[]
            {
                ...
                new WeaponDefinition(CanonicalWeaponId.PlasmaCutter, "EID-3 Plasma Cutter", WeaponDeliveryMode.Hitscan, DamageType.Energy, 34f, 2.5f, 12, 60, 2f, 36f, 0f, false, 1, 0f),
                new WeaponDefinition(CanonicalWeaponId.ArcThrower, "TX-40 Arc Thrower", WeaponDeliveryMode.Hitscan, DamageType.Energy, 22f, 3f, 20, 80, 2.4f, 22f, 0f, true, 1, 0f),
                ...
                new WeaponDefinition(CanonicalWeaponId.RiftGrenade, "Horizon RIFT Grenade", WeaponDeliveryMode.Projectile, DamageType.Explosive, 85f, 0.5f, 1, 5, 1.2f, 25f, 12f, false, 1, 0f),
                new WeaponDefinition(CanonicalWeaponId.TriShotRailPistol, "UEMF Tri-Shot Rail Pistol", WeaponDeliveryMode.Hitscan, DamageType.Ballistic, 18f, 2f, 18, 90, 1.6f, 48f, 0f, false, 3, 2.5f),
                new WeaponDefinition(CanonicalWeaponId.SawbladeLauncher, "Helion Industrial Sawblade Launcher", WeaponDeliveryMode.Projectile, DamageType.Ballistic, 65f, 1f, 4, 20, 2.5f, 35f, 18f, false, 1, 0f),
                new WeaponDefinition(CanonicalWeaponId.UnityBeamRifle, "ASCENDANT Unity Beam Rifle", WeaponDeliveryMode.SustainedBeam, DamageType.Energy, 10f, 12f, 100, 0, 0f, 60f, 0f, true, 1, 0f)
            };
        }
    }
}
